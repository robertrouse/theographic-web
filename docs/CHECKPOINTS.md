...
| 08  | [Generated definitions](checkpoints/CP-08-definitions.md)       | in-progress | `cp-08-definitions` | pipeline + site done, PR open; needs Robert: API credential, run the 30-entity dry run, review |
